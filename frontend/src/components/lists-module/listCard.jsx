                    ...
                    <div className="row mx-auto mt-2">
                        ...
                        <div className="col-sm-11 row">
                            <div className="list-owner col-sm-12">
                                <Link to={{ pathname: '/profile', state: { user_id: list.list_owner._id } }}><b>{list.list_owner.first_name} {list.list_owner.last_name} </b></Link>
                                <Link to={{ pathname: '/profile', state: { user_id: list.list_owner._id } }}>@{list.list_owner.user_name}</Link>
                            </div>
